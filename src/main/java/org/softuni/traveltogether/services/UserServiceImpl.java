...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository userRepository, RoleRepository roleRepository, Validator validator, ModelMapper modelMapper, BCryptPasswordEncoder bCryptPasswordEncoder, CloudService cloudService) {
    ...
    public void saveUser(UserServiceModel userServiceModel) {
        ...
        User user;
        if(userServiceModel.getId() != null && (userCandidate = this.userRepository.findById(userServiceModel.getId())).isPresent()) {
    ...
    @Override
    public void updateProfilePicture(UserServiceModel userServiceModel, MultipartFile pictureFile) throws IllegalAccessException {
